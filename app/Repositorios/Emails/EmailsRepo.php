...
class EmailsRepo 
{
     ...
     * Email De Contacto
     */
   public function EnvioEmailDeContacto($nombre,$email,$mensaje,$email_de_empresa,$nombre_empresa,$titulo_email,$request = null)               
    ...
    {   
         ...
         Mail::send('emails.solicitud_contacto' ,
                   ...
                   compact('nombre' , 'email','mensaje','titulo_email','request')       ,
